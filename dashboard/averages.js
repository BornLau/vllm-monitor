(() => {
  ...
  function chart(metric, title, color, start, end) {
    ...
    const meanLabel = mean == null ? '—' : mean.toLocaleString('zh-CN', {minimumFractionDigits: 1, maximumFractionDigits: 1});
